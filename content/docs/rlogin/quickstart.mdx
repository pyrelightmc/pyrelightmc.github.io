...
<Cards>
  <Card title="Premium auto-login" icon={<Icon name="CircleCheck" className="size-4" />} href="/docs/rlogin/features/premium-auth">
    How verification works, and which UUID players end up with.
  </Card>
  <Card title="All commands" icon={<Icon name="Terminal" className="size-4" />} href="/docs/rlogin/reference/commands">
